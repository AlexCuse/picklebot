module github.com/alexcuse/picklebot/edgex/device-gpio-alarm

replace github.com/edgexfoundry/go-mod-messaging/v2 => github.com/AlexCuse/go-mod-messaging/v2 v2.2.1-natsdev1
